                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="{{route('password.update')}}" method="POST">
                            ...
                            <input class="form-control" type="hidden" value="{{$token}}" name="token" required>
                            <input class="form-control" type="password" name="password" placeholder="گذرواژه جدید" required>
                            <input class="form-control" type="password" name="password_confirmation" placeholder="تکرار گذرواژه" required>
